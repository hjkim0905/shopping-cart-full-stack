...
participant DB as DB (CartItem / Product)
    ...
    rect rgb(255, 245, 230)
        ...
        Note over BE: 주문금액 계산<br/>쿠폰할인 계산 (최적 조합 선택)<br/>배송비 계산 (기본)
    ...
    rect rgb(230, 255, 240)
        ...
        FE->>BE: POST /order/preview<br/>{ selectedItemIds: [1,2,3], coupons: [0,1,2,3], isRemoteArea: true }
    ...
    rect rgb(255, 230, 255)
        ...
        Note over BE: 주문금액 계산<br/>선택한 쿠폰 2개 할인 계산<br/>배송비 계산 (도서·산간 요금)
